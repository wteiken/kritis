...
func (m *MockMetadataClient) GetAttestations(aa *kritisv1beta1.AttestationAuthority, containerImage string) ([]metadata.PGPAttestation, error) {
	return m.PGPAttestations[aa.Name], nil
}
